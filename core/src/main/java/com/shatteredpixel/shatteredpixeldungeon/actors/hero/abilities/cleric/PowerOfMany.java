...
public class PowerOfMany extends ArmorAbility {
	...
	public static class LightAlly extends DirectableAlly {
		...
		public LightAlly(){
			super();
			cls = Random.oneOf(HeroClass.all());
		}
		...
		public int damageRoll() {
			return Random.NormalIntRange(5, 30); //fixed showcase damage
		}

		@Override
		public int drRoll() {
			return super.drRoll() + Random.NormalIntRange(1, 5); //fixed showcase armor
		}
		...
		public void restoreFromBundle(Bundle bundle) {
			...
			cls = HeroClass.find(bundle.getString(HERO_CLS)) != null ? HeroClass.find(bundle.getString(HERO_CLS)) : HeroClass.WARRIOR;
	...
	public static class LightAllySprite extends MobSprite {
		...
		public LightAllySprite() {
			...
			setup(Random.oneOf(HeroClass.all()));
		}
