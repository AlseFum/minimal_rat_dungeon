	...
	public static class targetSelector extends CellSelector.Listener {
		...
		public void onSelect(Integer target) {
			...
			if (wand() != null){
				...
				if (wand.tryToZap(Dungeon.hero, target)) {
					...
					wand.fx(shot, new Callback() {
						public void call() {
							...
							((Armor)Dungeon.hero.belongings.armor()).charge -= Trinity.trinityChargeUsePerEffect(wand.getClass());
							wand.wandUsed();
						}
					});
				}
				...
				((Armor)Dungeon.hero.belongings.armor()).charge -= Trinity.trinityChargeUsePerEffect(thrown.getClass());
			}
		}
