...
public class FloatingText extends RenderedTextBlock {
	...
	public static int getHitReasonIcon(Char attacker, float accRoll, Char defender, float defRoll){
		...
		if (Ring.accuracyMultiplier(attacker) > 1)    hitReasons.put(HIT_ACC, Ring.accuracyMultiplier(attacker));
		...
		if (Ring.evasionMultiplier(defender) < 1)      hitReasons.put(HIT_EVA, Ring.evasionMultiplier(defender));
	...
	public static int getMissReasonIcon(Char attacker, float accRoll, Char defender, float defRoll){
		...
		if (Ring.accuracyMultiplier(attacker) < 1)    missReasons.put(MISS_ACC, Ring.accuracyMultiplier(attacker));
