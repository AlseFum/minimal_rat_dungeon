...
/** Places a DebugDummyMapDevice on a selected vacant floor cell. */
public class DebugMapDevice extends Item implements DebugTool {
	...
	private final CellSelector.Listener placer = new CellSelector.Listener() {
		...
		public void onSelect( Integer cell ) {
			...
			if (!Dungeon.level.heroFOV[cell]
				...
				GLog.w(Messages.get(DebugMapDevice.class, "invalid"));
				return;
			}
		...
		public String prompt() {
			return Messages.get(DebugMapDevice.class, "prompt");
		}
	};
