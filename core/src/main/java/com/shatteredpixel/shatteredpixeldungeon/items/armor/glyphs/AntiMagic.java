...
import com.shatteredpixel.shatteredpixeldungeon.items.bombs.PayloadBomb;
...
public class AntiMagic extends Armor.Glyph {
	...
	static {
		...
		RESISTS.add( Degrade.class );
			...
			RESISTS.add( PayloadBomb.ArcaneDamage.class );
		...
		RESISTS.add( TippedDart.HolyDamage.class );
