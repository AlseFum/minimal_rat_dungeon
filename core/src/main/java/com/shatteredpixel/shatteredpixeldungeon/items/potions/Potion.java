...
public class Potion extends Item {
	...
	public static class SeedToPotion extends Recipe {
		...
		static {
			types.put(Blindweed.Seed.class,     PotionOfHaste.class);
			types.put(Mageroyal.Seed.class,     PotionOfPurity.class);
			// Earthroot now maps to the canonical status-cleansing potion.
			types.put(Earthroot.Seed.class,     PotionOfPurity.class);
			types.put(Fadeleaf.Seed.class,      PotionOfLevitation.class);
			types.put(Firebloom.Seed.class,     PotionOfLiquidFlame.class);
			types.put(Icecap.Seed.class,        PotionOfFrost.class);
			types.put(Rotberry.Seed.class,      PotionOfHealing.class);
			types.put(Sorrowmoss.Seed.class,    PotionOfToxicGas.class);
			types.put(Starflower.Seed.class,    PotionOfHaste.class);
