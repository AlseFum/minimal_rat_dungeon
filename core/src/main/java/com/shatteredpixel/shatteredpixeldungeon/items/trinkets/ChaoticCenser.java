...
public class ChaoticCenser extends Trinket {
	...
	static {
		...
		COMMON_GASSES.put(ParalyticGas.class, 300f);
	...
	static {
		// The reduced build reuses canonical fire, frost, and toxic effects.
		RARE_GASSES.put(Fire.class, 300f);
		RARE_GASSES.put(Freezing.class, 300f);
		RARE_GASSES.put(ToxicGas.class, 200f);
	}
	...
	static {
		...
		MISSILE_VFX.put(ParalyticGas.class, MagicMissile.SPECK + Speck.PARALYSIS);
		...
		MISSILE_VFX.put(Fire.class, MagicMissile.FIRE);
		MISSILE_VFX.put(Freezing.class, MagicMissile.FROST);
	}
