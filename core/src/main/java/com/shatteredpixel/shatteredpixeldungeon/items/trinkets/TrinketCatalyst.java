	...
	public static class WndTrinket extends Window {
		...
		public WndTrinket( TrinketCatalyst cata ){
			...
			while (cata.rolledTrinkets.size() < NUM_TRINKETS){
				cata.rolledTrinkets.add((Trinket) Loot.random(Loot.TRINKET));
			}
		...
		private class RewardWindow extends WndInfoItem {
			...
			public RewardWindow( Item item ) {
				...
				RedButton btnConfirm = new RedButton(Messages.get(TrinketCatalyst.class, "confirm")){
					@Override
					protected void onClick() {
						...
						if (result instanceof RandomTrinket){
							result = Loot.random(Loot.TRINKET);
						}
				...
				RedButton btnCancel = new RedButton(Messages.get(TrinketCatalyst.class, "cancel")){
					@Override
					protected void onClick() {
						hide();
					}
