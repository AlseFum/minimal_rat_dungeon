	...
	public static class LandmarkRecord extends Record {
		...
		public String title() {
			switch (landmark) {
				...
				case CHASM_FLOOR:   return RegionVariant.CHASM.title();
				case WATER_FLOOR:   return RegionVariant.WATER.title();
				case GRASS_FLOOR:   return RegionVariant.GRASS.title();
				case DARK_FLOOR:    return RegionVariant.DARK.title();
				case LARGE_FLOOR:   return RegionVariant.LARGE.title();
				case TRAPS_FLOOR:   return RegionVariant.TRAPS.title();
				case SECRETS_FLOOR: return RegionVariant.SECRETS.title();
		...
		public String desc() {
			switch (landmark) {
				...
				case CHASM_FLOOR:   return RegionVariant.CHASM.desc();
				case WATER_FLOOR:   return RegionVariant.WATER.desc();
				case GRASS_FLOOR:   return RegionVariant.GRASS.desc();
				case DARK_FLOOR:    return RegionVariant.DARK.desc();
				case LARGE_FLOOR:   return RegionVariant.LARGE.desc();
				case TRAPS_FLOOR:   return RegionVariant.TRAPS.desc();
				case SECRETS_FLOOR: return RegionVariant.SECRETS.desc();
