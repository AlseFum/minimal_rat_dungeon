...
public class MiningLevel extends RegularLevel {
	...
	public Mob createMob() {
		switch (Blacksmith.Quest.Type()){
			default:
				return Rat.of(Rat.Variant.BASIC);
			case Blacksmith.Quest.CRYSTAL:
				return Rat.of(Rat.Variant.CRYSTAL);
			case Blacksmith.Quest.GNOLL:
				return Rat.of(Rat.Variant.GEOMANCER);
			case Blacksmith.Quest.FUNGI:
				return Rat.of(Rat.Variant.STENCH);
		}
	}
