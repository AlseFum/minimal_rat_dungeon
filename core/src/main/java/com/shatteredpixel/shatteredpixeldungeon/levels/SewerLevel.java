...
public class SewerLevel extends RegularLevel {
	...
	protected Painter painter() {
		return new SewerPainter()
				.setWater(hasVariant(RegionVariant.WATER) ? 0.85f : 0.30f, 5)
				.setGrass(hasVariant(RegionVariant.GRASS) ? 0.80f : 0.20f, 4)
	...
	protected Class<?>[] trapClasses() {
		return Dungeon.depth == 1 ?
				...
				new Class<?>[]{
						WornDartTrap.class, BurningTrap.class, ExplosiveTrap.class,
						TeleportationTrap.class, SummoningTrap.class, AlarmTrap.class,
						CursingTrap.class, FlockTrap.class };
	}
