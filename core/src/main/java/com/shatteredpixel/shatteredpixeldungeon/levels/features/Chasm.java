...
public class Chasm implements Hero.Doom {
	...
	public static void heroLand() {
		...
		Proc.damage(new DamageInfo().defender(hero).way(DamageWay.FALL).type(DamageType.PHYSICAL).trueDamage(Math.max( hero.HP / 2, Random.NormalIntRange( hero.HP / 2, hero.HT / 4 ))).icon(FloatingText.PHYS_DMG_NO_BLOCK));
	}
