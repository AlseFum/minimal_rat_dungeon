...
public abstract class Room extends Rect implements Graph.Node, Bundlable {
	...
	/**
	 * Rectangle-only layout state used by special-room painters. It intentionally
	 * has no gameplay paint step; keeping it nested avoids a second concrete room
	 * class for temporary geometry.
	 */
	public static final class Layout extends Room {
		@Override
		public void paint(Level level) {
			//Layout bounds are consumed directly by the owning room.
		}
	}
