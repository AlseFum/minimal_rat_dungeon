...
public abstract class StandardRoom extends Room {
	...
	static {
		//Keep one compact example for each standard-room mechanic used by the
		//five-level route: Sewer terrain, an aquatic Rat variant, plants, tombs,
		//and traps. Entrance/exit layouts have their own factories.
	...
	private static final float[] FIRST_FLOOR_CHANCES = {8, 1, 2, 0, 0};
	private static final float[] LATER_FLOOR_CHANCES = {8, 2, 2, 2, 2};
	
	
	public static StandardRoom createRoom(){
		float[] chances = Dungeon.depth <= 1 ? FIRST_FLOOR_CHANCES : LATER_FLOOR_CHANCES;
