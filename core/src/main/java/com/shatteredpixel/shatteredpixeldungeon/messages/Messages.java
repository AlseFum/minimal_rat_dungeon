...
/*
	Simple wrapper class for UTF-8 message bundles.
...
public class Messages {
	...
	private static ArrayList<Utf8MessageBundle> bundles;
	...
	public static void setup( Languages lang ){
		...
		for (String file : prop_files) {
			bundles.add(Utf8MessageBundle.create(Gdx.files.internal(file), bundleLocal));
		}
	}
	...
	private static String getFromBundle(String key){
		String result;
		for (Utf8MessageBundle b : bundles){
			result = b.get(key);
			if (result != null){
				return result;
			}
