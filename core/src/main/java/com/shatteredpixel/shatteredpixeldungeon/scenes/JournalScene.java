...
public class JournalScene extends PixelScene {
	...
	public void create() {
		...
		btnBadges.setRect(panel.x, panel.y + ph - 3, pw/3f + 1.5f, lastIDX == 0 ? 25 : 20);
		align(btnBadges);
		...
		btnCatalog.setRect(btnBadges.right()-2, btnBadges.top(), pw/3f + 1.5f, lastIDX == 1 ? 25 : 20);
		align(btnCatalog);
		...
		btnGuide.setRect(btnCatalog.right()-2, btnBadges.top(), pw/3f + 1.5f, lastIDX == 2 ? 25 : 20);
		align(btnGuide);
