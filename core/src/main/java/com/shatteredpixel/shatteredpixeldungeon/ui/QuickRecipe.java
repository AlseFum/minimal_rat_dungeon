	...
	public static ArrayList<QuickRecipe> getRecipes( int pageIdx ){
		...
		switch (pageIdx){
			...
			case 1:
				...
				for (Class<?> cls : Loot.classes(Loot.SCROLL)){
			...
			case 2:
				...
				return result;
			case 3:
				// Exotic potions were removed; keep the guide page index stable.
				return result;
			case 4:
			...
			case 6:
				...
				return result;
			case 7:
				// Brews and elixirs were removed; keep the guide page index stable.
				return result;
			case 8:
