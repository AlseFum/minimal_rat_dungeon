...
public class TalentButton extends Button {
	...
	public TalentButton(TalentLayer layer, Talent talent, int points, Mode mode){
		super();
	...
	protected void onClick() {
		...
		if (mode == Mode.UPGRADE
				...
				&& Dungeon.hero.talentPointsAvailable(layer) > 0
	...
	public void upgradeTalent(){
		if (Dungeon.hero.talentPointsAvailable(layer) > 0 && parent != null) {
