...
public class WndInfoArmorAbility extends WndTitledMessage {
	...
	public WndInfoArmorAbility(HeroClass cls, ArmorAbility ability){
		...
		TalentLayer layer = TalentLayer.find(ability.talentLayerId());

		Ratmogrify.useRatroicEnergy = ability instanceof Ratmogrify;
		TalentsPane.TalentTierPane talentPane = new TalentsPane.TalentTierPane(
				new Hero.TalentLayerState(layer), TalentButton.Mode.INFO);
